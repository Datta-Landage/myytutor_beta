...
public class WhatsAppService {
        ...
        public void sendInquiryConfirmation(String customerPhone, String customerName, String inquiryId) {
                try {
                        ...
                        // Template: Hello {{1}}, We have received Your enquiry ID: *{{2}}*. and our
                        // team will connect with you within 30 minutes with the best suitable tutor.
                        WhatsAppMessageRequest request = WhatsAppMessageRequest.builder()
                                        ...
                                        .template(WhatsAppMessageRequest.TemplateMessage.builder()
                                                        ...
                                                        .language(WhatsAppMessageRequest.TemplateMessage.Language
                                                                        .builder()
                                                                        .code("en")
                                                                        .build())
                                                        .components(Arrays.asList(
                                                                        WhatsAppMessageRequest.TemplateMessage.Component
                                                                                        .builder()
                                                                                        .type("body")
                                                                                        .parameters(Arrays.asList(
                                                                                                        WhatsAppMessageRequest.TemplateMessage.Component.Parameter
                                                                                                                        .builder()
                                                                                                                        .type("text")
                                                                                                                        .text(customerName)
                                                                                                                        .build(),
         ...
         * Template: A new enquiry is available for review. Class: {{1}} Subjects: {{2}}
         * Board:{{5}} Location: {{3}} Preferred Time: {{4}} Preferred Date: {{6}}
         */
        ...
        public void sendFullInquiryToAdmin(Inquiry inquiry) {
                try {
                        ...
                        sendMessage(request);
                        log.info("✅ Sent full inquiry details to admin using template for inquiry #{}",
                                        inquiry.getId());
                } catch (Exception e) {
        ...
        public void addTeacherToCommunity(Teacher teacher) {
                try {
                        ...
                        log.info("✅ Sent teacher registration success using template to: {} ({})",
                                        teacher.getFullName(), teacherPhone);
                } catch (Exception e) {
        ...
        private void sendMessage(WhatsAppMessageRequest request) {
                try {
                        ...
                        log.debug("WhatsApp Config - Access Token (first 20 chars): {}...",
                                        whatsAppConfig.getAccessToken() != null
                                                        ? whatsAppConfig.getAccessToken()
                        ...
                        if (request.getText() != null) {
                                log.debug("Request - Message Body Length: {} chars",
                                                request.getText().getBody() != null
                                                                ? request.getText().getBody().length()
                                                                : 0);
                                log.debug("Request - Message Preview: {}...", request.getText().getBody() != null
                                                && request.getText().getBody().length() > 50
                                                                ? request.getText().getBody().substring(0, 50)
                                                                : request.getText().getBody());
                        }
                        ...
                        if (response.getStatusCode().is2xxSuccessful()) {
                                ...
                                log.debug("Response details - Status: {}, Body: {}", response.getStatusCode(),
                                                response.getBody());
                        } else {
